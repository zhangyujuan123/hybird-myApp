            ...
            <View>
                ...
                <View style={styles.top}>
                    <View style={{flexDirection:'row',alignItems:'center',backgroundColor:'#fbb8b8',borderRadius:20,width:515*s}}>
                        ...
                        <TextInput placeholder='请输入您要的关键字' placeholderTextColor='#ffffff' style={{fontSize:17}}/>
                    </View>
                ...
                <View>
                    <ScrollView ref="scrollView"
                        ...
                        <Image resizeMode ='contain' source={require('../images/ban_02.png')} style={styles.img}/>
                        <Image resizeMode ='contain' source={require('../images/ban_02.png')} style={styles.img}/>
                        <Image resizeMode ='contain' source={require('../images/ban_02.png')} style={styles.img}/>
                    </ScrollView>
                    <View style={styles.circle}>
                        {
                            [0,1,2].map((item)=>{
                                ...
                                return <Text key={item} style={[{fontSize:50,margin:5}, style]}>&bull;</Text>;
                            })
                        }
                    </View>
                </View>
