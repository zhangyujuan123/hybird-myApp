...
export default class MyPage extends Component {
    constructor(){
        super();
        this.state={
            imageUrl:require('../../images/pir_03.jpg')
        }
    }
    componentDidMount(){
    ...
    render() {
        return (
            <View>
                ...
                <TouchableOpacity style={{width:'100%',backgroundColor:'#fff',height:50,marginTop:20,justifyContent:'center'}} onPress={()=>this.removeLogin()}><Text style={{color:'red',textAlign:'center'}}>退出登录</Text></TouchableOpacity>
